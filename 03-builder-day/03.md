...
func (e *EnvironmentConfigLoader) Load() (*Config, error) {
	config := &Config{
		...
		Database: DatabaseConfig{
			...
			Database:        getEnvString("DB_NAME", "chinook"),
...
// ConnectionString builds a database connection string
...
import (
	...
	"github.com/chinook/data-pipeline/internal/config"
...
import (
	...
	"github.com/chinook/data-pipeline/internal/config"
	"github.com/chinook/data-pipeline/internal/container"
	"github.com/chinook/data-pipeline/internal/domain"
)
...
import (
	...
	"github.com/chinook/data-pipeline/internal/app"
	"github.com/chinook/data-pipeline/internal/config"
	"github.com/chinook/data-pipeline/internal/container"
	"github.com/chinook/data-pipeline/internal/domain"
)
...
func main() {
	fmt.Println("🧬 Dependency Injection Laboratory")
	fmt.Println("=================================")
...
func testContainerBuilding() {
	...
	cont := container.NewContainer(cfg)
	if err := cont.Build(); err != nil {
		fmt.Printf("❌ Container building failed: %v\n", err)
		return
	}
	...
	if customerService == nil {
		fmt.Printf("❌ Customer service not available\n")
		return
	}
	fmt.Printf("✅ Customer service available\n")

	errorService := cont.ErrorHandlingService()
	if errorService == nil {
		fmt.Printf("❌ Error handling service not available\n")
		return
	}
	fmt.Printf("✅ Error handling service available\n")

	logger := cont.Logger()
	if logger == nil {
		fmt.Printf("❌ Logger not available\n")
		return
	}
	fmt.Printf("✅ Logger available\n")
	...
	if err != nil {
		...
		fmt.Printf("✅ Customer created via DI: ID=%d\n", created.Customer.ID)
	}
...
func testServiceFactories() {
	...
	if fullService != nil {
		fmt.Printf("   ✅ Full-featured service created\n")
	}
	...
	if minimalService != nil {
		fmt.Printf("   ✅ Minimal service created\n")
	}
	...
	if err1 == nil && err2 == nil {
		fmt.Printf("   ✅ Both service variants work correctly\n")
	} else {
		fmt.Printf("   ❌ Service variants failed: %v, %v\n", err1, err2)
	}
}
...
func testApplicationLifecycle() {
	...
	if err != nil {
		fmt.Printf("❌ Application creation failed: %v\n", err)
		return
	}
	...
	if err := application.Stop(shutdownCtx); err != nil {
		fmt.Printf("❌ Application shutdown failed: %v\n", err)
	} else {
		fmt.Printf("✅ Application shutdown successful\n")
	}

	fmt.Println("\n🎉 Dependency injection testing completed!")
	fmt.Println("\n💡 Key Benefits Demonstrated:")
	fmt.Println("   ✅ Configuration-driven dependency creation")
	fmt.Println("   ✅ Explicit dependency injection (no magic)")
	fmt.Println("   ✅ Service lifecycle management")
	fmt.Println("   ✅ Health checking and graceful shutdown")
	fmt.Println("   ✅ Factory patterns for service customization")
	fmt.Println("   ✅ Testable service composition")
}
```

## 💥 Deliberate Failure: Dependency Issues
...
**Next**: Head to `lab04/` for comprehensive testing architecture! 🧪