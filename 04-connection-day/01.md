...
import (
	...
	"github.com/chinook/data-pipeline/internal/config"
	"github.com/chinook/data-pipeline/internal/database"
	"github.com/chinook/data-pipeline/internal/domain"
	"github.com/chinook/data-pipeline/internal/mocks"
)

func main() {
	fmt.Println("🗄️ SQLite Integration Laboratory")
	fmt.Println("=================================")
...
func testDatabaseConnection() {
	...
	fmt.Printf("✅ Found %d customers in Chinook database\n", count)
	...
	fmt.Printf("✅ Sample customer: %s (%s)\n", name, email)
}
...
func testTransactions() {
	...
	if err != nil {
		...
		fmt.Printf("   ❌ Transaction should have rolled back\n")
	}
	...
	if count == 0 {
		fmt.Printf("   ✅ Rollback verified - event not found\n")
	} else {
		fmt.Printf("   ❌ Rollback failed - event found\n")
	}
}
...
func testMonitoring() {
	...
	for i := 0; i < 3; i++ {
		...
		db.HealthCheck(ctx)
		fmt.Printf("   ✅ Health check %d completed\n", i+1)
	}
	...
	fmt.Println("\n🎉 SQLite integration testing completed!")
}
```
...
**Next**: Head to `lab02/` to implement the repository pattern! 🔄